...
/* ==========================================================================
   ...
   ========================================================================== */
window.PLATFORM = {
  name: { ar: "رنت ستور", en: "RentStore" },          // ← your brand name
  mark: { ar: "ر", en: "R" },
  domain: "rentstore.ae",                           // ← used in the @handle preview
...
window.I18N = {
  ar: {
    ...
    "land.claimLabel": "اسم صفحتك على رنت ستور",
    "land.claimPh": "ahmed",
    "land.claimGo": "سجّل بهذا الاسم",
    "land.claimNote": "التسجيل مجاني وبدون بطاقة بنكية. وتوفّر الاسم نأكده لك وقت مراجعة طلبك.",
    "land.claimEmpty": "اكتب اسم صفحتك أول.",
    "land.claimLatin": "اسم الصفحة يكون بحروف إنجليزية وأرقام. مثال: ahmed",
    "land.stepArt": "هذي الصفحة اللي تجهّزها في الخطوة الثانية، من المتجر التجريبي نفسه.",
  ...
  en: {
    ...
    "land.claimLabel": "Your RentStore page name",
    "land.claimPh": "ahmed",
    "land.claimGo": "Sign up with this name",
    "land.claimNote": "Signing up is free and needs no card. We confirm the name is still yours to take when we read your request.",
    "land.claimEmpty": "Type your page name first.",
    "land.claimLatin": "Page names use Latin letters and numbers. Example: ahmed",
    "land.stepArt": "The page you set up in step two, taken from the demo store itself.",
