...
```bash
npx serve projects/matjari/pages          # or open pages/index.html directly
node projects/matjari/code/bundle.mjs     # → standalone.html, the whole site in one file
```
...
point it at `projects/matjari/pages`. Before going live, change the `<title>`,
