...
const SRC = path.join(ROOT, 'examples', 'picker.html');
const OUT = path.join(ROOT, 'examples', 'intake-standalone.html');
...
<title>${title}</title>
<!-- Generated by tools/build-standalone.js — edit examples/picker.html, not this file. -->
<style>
${css}
${themeLayer}
${ownStyle}
